...
import com.wanted.momocity.auth.application.service.EmailVerifyService;
...
public class EmailVerifyTest {
    ...
    @BeforeEach
    void setup() {
        assertNotNull(emailVerifyService);
    }
    ...
    void 이메일_인증코드_만료() {
        ...
        InvalidVerificationCodeException exception = assertThrows(
                ...
                () -> emailVerifyService.emailVerify(new EmailVerifyCommand("test@test.com", "123456"))
        );
    ...
    void 이메일_인증코드_불일치() {
        ...
        InvalidVerificationCodeException exception = assertThrows(
                InvalidVerificationCodeException.class,
                () -> emailVerifyService.emailVerify(new EmailVerifyCommand("test@test.com", "999999"))
        );
