...
INSERT INTO `notification` (`id`, `created_at`, `is_read`, `message`, `ref_id`, `type`, `user_id`) VALUES
  (1, NOW() - INTERVAL 2 DAY, 0, '김민수님이 댓글을 달았습니다', 1, 'COMMENT', 13),
  (2, NOW() - INTERVAL 1 DAY, 0, '이지영님이 좋아요를 눌렀습니다', 1, 'LIKE', 12),
  (3, NOW() - INTERVAL 12 HOUR, 1, '새 강의가 등록되었습니다', 1, 'LECTURE', 14),
  (4, NOW() - INTERVAL 6 HOUR, 0, '친구 요청이 왔습니다', 15, 'FRIEND', 12);
