...
INSERT INTO `store` (`id`, `created_at`, `name`, `price`, `type`, `url`) VALUES
  ...
  (6, NOW() - INTERVAL 120 DAY, '프로필 이미지 6', 350, 'PROFILE', 'https://momocity-bucket.s3.ap-northeast-2.amazonaws.com/store/item06.png'),
  (7, NOW() - INTERVAL 120 DAY, '프로필 이미지 7', 400, 'PROFILE', 'https://momocity-bucket.s3.ap-northeast-2.amazonaws.com/store/item07.png'),
  (8, NOW() - INTERVAL 120 DAY, '프로필 이미지 8', 450, 'PROFILE', 'https://momocity-bucket.s3.ap-northeast-2.amazonaws.com/store/item08.png');
-- =====================================================================
--  3. order_history — 50건
-- =====================================================================
