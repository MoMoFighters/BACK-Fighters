...
import com.wanted.momocity.study.presentation.api.response.TimerEndResponse;
import com.wanted.momocity.study.presentation.api.response.TimerPauseResponse;
import com.wanted.momocity.study.presentation.api.response.TimerStartResponse;
...
public class TimerController {
    ...
    public ResponseEntity<ApiResponse<TimerEndResponse>> end(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                ...
                "타이머를 종료했습니다.",
                new TimerEndResponse(result.roomId(), result.memberId(), result.accumulatedSeconds())
        ));
    }
}